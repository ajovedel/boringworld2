...
KOBJS := irq_setup.o assert.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o install_handler.o swi_handler.o irq_handler.o c_swi_handler.o c_irq_handler.o interrupt_setup.o timer_setup.o call_user.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
